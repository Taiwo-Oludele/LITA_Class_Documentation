...
## Tools Used: Excel, SQL & Power Bi
 ...
 ### Power BI
 #### Models : allows users to filter and highlight data across various visuals and data sources, features that depend on relationships between tables to facilitates report and dashboard.
 #### Conditional Column
 #### Measure
